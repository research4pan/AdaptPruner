...
def prepare_model_for_int8_training(
    ...
    if hasattr(model, output_embedding_layer_name):
        ...
        try:
            ...
            for name, module in output_embedding_layer.named_modules():
                if hasattr(module, 'weight'):
                    input_dtype = module.weight.dtype
                    print(f"Found dtype in submodule {name}: {input_dtype}")
                    break
        ...
        if 'CastOutputToFloat' not in str(type(output_embedding_layer)):
