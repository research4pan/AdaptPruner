...
def _compute_llama3_parameters(
    config: PretrainedConfig, device: "torch.device", seq_len: Optional[int] = None, layer_idx: Optional[int] = 0, **rope_kwargs
) -> Tuple["torch.Tensor", float]:
    """
    ...
    """
    # Gets the default RoPE parameters
    inv_freq, attention_factor = _compute_default_rope_parameters(config, device, seq_len, layer_idx, **rope_kwargs)
