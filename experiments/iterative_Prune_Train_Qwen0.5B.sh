...
base_dir="${save_dir}/iterative_prune_train_Qwen2.50.5B_instruct_1_${iterative_prune_train_step}_steps_repeat_${repeat_dataset}_strategy_${seperate_strategy}_${micro_batch_size}_microbatch_size_${lr_scheduler}_max_lr_${learning_rate}"
...
original_param_num=494032768
target_param_num=376100000
...
for stage in $(seq 1 ${iterative_prune_train_step}); do
    ...
    python ../utils/hf_prune.py \
        ...
        --block_mlp_layer_end 24 \
        --block_attention_layer_start 0 \
        --block_attention_layer_end 24 \
